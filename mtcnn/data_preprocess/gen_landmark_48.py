...
annotation_file = os.path.join(base_path, "./data_set/face_landmark/train/trainImageList.txt")
...
def gen_data(anno_file, data_dir, prefix):
    ...
    anno_dir = os.path.join(base_path, './anno_store')
    ...
    for annotation in annotations:
        ...
        im_path = os.path.join(os.path.join(base_path, './data_set/face_landmark/train/'), annotation[0].replace("\\", "/"))
