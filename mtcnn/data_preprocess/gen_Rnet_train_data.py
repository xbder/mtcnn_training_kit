...
pnet_model_file = os.path.join(base_path, './model_store/pnet_epoch_10.pt')
...
def gen_rnet_data(data_dir, anno_file, pnet_model_file, prefix_path='', use_cuda=True, vis=False):
    ...
    # load original_anno_file, length = 12879（原为12880，但图片54--Rescue\54_Rescue_rescuepeople_54_29.jpg的标注坐标出现负数，标注错误，故删掉）
